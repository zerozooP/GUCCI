				...
				<main>
					...
					<div class="container">
					    ...
					    <div class="btn1">
						    ...
						    <c:if test="${uid==duid}">
		   					    <button type="button" onclick="edit();" class="btn btn-outline-primary btn-sm">수정</button>
		   					    <button type="button" onclick="del();" class="btn btn-outline-primary btn-sm">삭제</button>
						    </c:if>
						    <!-- end -->
